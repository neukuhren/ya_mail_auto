...
def read_txt_file_on_lines_and_return_to_list(file_name : str) -> list:
    ...
    try:
        with open(file_name) as file:
            ...
            while line := file.readline():
                ...
                if len(_user_data_dict) == 2:  # Если Answer из txt файла не получен, то поставим None
                    _user_data_dict[LIST_WITH_COLUMNS_COMBINED[2]] = None
...
def write_to_excel(list_with_data, file_name : str):
...
def read_combined_main(mode: int):
    ...
    if mode == 1:
        ...
        input_file_name='combined_mailru.txt'
        output_file_name='combined_mailru.xlsx'    
